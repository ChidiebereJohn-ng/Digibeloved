        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="/digibeloved_hq.png" alt="The DigiBeloved team at No 3 Maitama, Abuja" className="rounded-2xl shadow-2xl transition-all duration-700 hover:shadow-3xl" />
